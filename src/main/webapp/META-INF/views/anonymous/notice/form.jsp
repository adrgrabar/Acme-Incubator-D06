...
<acme:form>
	...
	<acme:form-url code="anonymous.notice.form.label.picture" path="picture"/>
	<acme:form-moment code="anonymous.notice.form.label.date" path="date"/>
	<acme:form-moment code="anonymous.notice.form.label.deadline" path="deadline"/>
	<acme:form-textbox code="anonymous.notice.form.label.links" path="links"/>
