...
<acme:form>
	...
	<acme:form-url code="authenticated.notice.form.label.picture" path="picture"/>
	<acme:form-moment code="authenticated.notice.form.label.date" path="date"/>
	<acme:form-moment code="authenticated.notice.form.label.deadline" path="deadline"/>
	<acme:form-textbox code="authenticated.notice.form.label.links" path="links"/>
